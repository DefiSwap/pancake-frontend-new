    ...
    >
      <S.Inner>
        ...
        <RightWrapper>
          {isDesktop ? (
            <>
              <Image src="https://i.imgur.com/FQszbms.png" alt="opbnbBunny" width={172} height={200} placeholder="blur" />
            </>
          ) : (
            <Image src="https://i.imgur.com/FQszbms.png" alt="opbnbBunny" width={151} height={176} placeholder="blur" />
          )}
          <BgWrapper>
            {isDesktop ? (
              <>
