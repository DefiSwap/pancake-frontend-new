  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/pattieswap.finance/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/pattieswap.finance/',
    },
    {
      id: 'binance',
    ...
    },
    {
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://pattieswap.finance/',
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.pattieswap.finance/v/${docLangCodeMapping[code]}/get-started/wallet-guide`
